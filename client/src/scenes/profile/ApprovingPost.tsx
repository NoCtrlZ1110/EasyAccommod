import { Button, Card, Divider, Form, Input, Modal, Radio, Row, Select, Space, Table } from "antd";
import React, { useState } from "react";
import { DeleteOutlined, EditTwoTone, ExclamationCircleOutlined, AppleOutlined } from '@ant-design/icons';
        ...
        },
        {
            ...
            render: (text: any, record: any) => (
                <>
                    ...
                    <DeleteOutlined style={{ marginLeft: 30, color: "red" }} onClick={confirmDelete} />
                </>
            ),
        },
    ];
