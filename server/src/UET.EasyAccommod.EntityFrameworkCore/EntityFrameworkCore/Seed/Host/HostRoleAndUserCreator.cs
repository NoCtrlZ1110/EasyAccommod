...
namespace UET.EasyAccommod.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly EasyAccommodDbContext _context;

        public HostRoleAndUserCreator(EasyAccommodDbContext context)
        {
            _context = context;
        }
